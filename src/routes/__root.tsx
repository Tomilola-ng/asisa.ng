  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: PLATFORM_NAME },
      {
        ...
        content:
          "Courses, feeds, groups and resources for ASI students at the University of Lagos.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/asisa-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/asisa-logo.png" },
    ],
  }),
